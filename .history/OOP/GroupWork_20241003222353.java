...
class LoanAccount{
    ...
    private double loanAmount, intrestRate, balance, makePayment;
    ...
    public double getBalance() {
        return balance = (loanAmount / (loanTerm * 12)) - makePayment ;
    }
...
public class GroupWork{
    ...
    public static void main(String[] args) {
        ...
        double loanAmount, intrestRate,makePayment;
        int loanTerm;
        char YesNo = false;
        //User inputs 
        ...
        System.out.println(Loan.makePayment());
    }
}

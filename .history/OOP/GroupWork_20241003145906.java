...
class Magazine{
    private int MagazineCode,NumberFoPages;
    private double CostForThePage,TotalCost;
    ...
    public void setCalculateTotalCost(){
...
// Info: total cost=cost for a page * number of pages
    public static void main(String[] args) {
        int MagazineCode,NumberFoPages;
        double CostForThePage,TotalCost;
